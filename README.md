...
- Clone complete repo including submodules  
  `git clone --recurse-submodules --depth 1 --single-branch https://github.com/DalhousieSpaceSystemsLab/MANTIS-STM32_Base_Project <your_project_name>`    
...
- Clone this repo only and change paths of CMSIS and FreeRTOS in the **CmakeLists.txt** to the ones you already have.  
  `git clone --depth 1 --single-branch https://github.com/DalhousieSpaceSystemsLab/MANTIS-STM32_Base_Project <your_project_name>`
